...
flowchart LR
    ...
    Boundary["BOUNDARY<br/>Home Network ↔ Internet"]
    ...
    GitHub -. "HTTPS / Web" .- Laptop
    Moodle -. "HTTPS / Web" .- Laptop
    OneDrive -. "HTTPS / Web" .- Laptop
    Tero -. "HTTPS / Web" .- Laptop
    Phone -. "HTTPS / MFA" .- Internet
```
